...
public class DeTaiDuocDuyetAdapter extends RecyclerView.Adapter<DeTaiDuocDuyetAdapter.MyViewHolder> {
...
//    DeTaiNghienCuu deTaiNghienCuu;
    ...
    public DeTaiDuocDuyetAdapter(Context context, Activity activity, List<DeTaiNghienCuu> listDeTaiNghienCuu) {
    ...
    @NonNull
    @Override
    public DeTaiDuocDuyetAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.dong_de_tai_duyet,parent,false);
        return new DeTaiDuocDuyetAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DeTaiDuocDuyetAdapter.MyViewHolder holder, int position) {
