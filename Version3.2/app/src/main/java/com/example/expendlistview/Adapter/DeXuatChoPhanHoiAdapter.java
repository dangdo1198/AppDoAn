...
public class DeXuatChoPhanHoiAdapter extends RecyclerView.Adapter<DeXuatChoPhanHoiAdapter.MyViewHolder> {
    ...
    public DeXuatChoPhanHoiAdapter(Context context, Activity activity, List<CTLKDoanhNghiep> listCtklDoanhNghiep ) {
    ...
    @NonNull
    @Override
    public DeXuatChoPhanHoiAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.dong_de_xuat_cho_phan_hoi,parent,false);
        return new DeXuatChoPhanHoiAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DeXuatChoPhanHoiAdapter.MyViewHolder holder, int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView idTxt,tenChuongTrinhTxt, thoiGianDuKienTxt;
