...
public class DeXuatDongYAdapter extends RecyclerView.Adapter<DeXuatDongYAdapter.MyViewHolder> {
    ...
    public DeXuatDongYAdapter(Context context, Activity activity, List<CTLKDoanhNghiep> listCtklDoanhNghiep ) {
    ...
    @NonNull
    @Override
    public DeXuatDongYAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.dong_de_xuat_dong_y,parent,false);
        return new DeXuatDongYAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DeXuatDongYAdapter.MyViewHolder holder, int position) {
